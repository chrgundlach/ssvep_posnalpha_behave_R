...
print(g)
# ggsave(filename = "figures/MarginEffects_VisAlphaTarg_PredSlopes_ModelValVisAlphaContrIpsi.eps",
#        width = 5, height = 3.5,
#        plot = print(g))
...
```{r motor alpha model marginal effects disp effects visual alpha -marginal means,  fig.height=5.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# now trying to get the regression line right for the alpha predictors
...
# print(g)
ggsave(filename = "figures/MarginEffects_MotAlphaTarg_PredSlopes_ModelValMotAlpha_PreTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_MotAlphaTarg_SlopeDistr_ModelValMotAlpha_PreTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
```{r winning model marginal effects disp effects SSVEP interaction -marginal means,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# now trying to get the regression line right for the alpha predictors
...
###  Extract marginal effects for post-cue motor alpha * Validity model
...
```{r motor alpha model post-target inter marginal effects disp effects visual alpha -marginal means,  fig.height=3.5, fig.width=3,  warning = FALSE, message=FALSE, eval = TRUE}
# now trying to get the regression line right for the alpha predictors
