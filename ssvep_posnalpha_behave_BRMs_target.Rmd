---
title: "BRMS analysis | Posnalpha Behave | target window"
...
<br>
...is related to trial-by-trial variance of amplitude values of pre-target [-1000 to 0]ms and post-cue [0 to 1000]ms  **alpha-band activity** and **SSVEPs**...

```{r SSVEP and alpha distribution all trials, fig.height=3.5, fig.width=8, message=FALSE, warning=FALSE, results="hide"}
dat_plot <- DATA.In_longer %>%
  dplyr::select(subject, trialnumber,time, cue_validity_label, pos_rel_target, amplitude, signal, post_hit)%>%
  filter(post_hit=="hit", time=="[-1000 0]ms")%>%
...
<br>
We do know that all these signals are modulated by attention, prior to the target [-1000 0]ms. But do the electrophysiological measures correspond to (or even represent) processes relevant for instantiating behaviorally relevant attention processes?
...
dat_plot <- DATA.In_longer %>%
  ...
  filter(post_hit=="hit", signal == "visualAlpha", pos_rel_target == "contra_target", time == "[-1000 0]ms")
...
dat_plot <- DATA.In_longer %>%
  dplyr::select(subject, trialnumber, cue_validity_label, post_event_pos_label, post_hit, amplitude, signal, pos_rel_target, time)%>%
  filter(post_hit=="hit", signal == "visualAlpha", pos_rel_target == "contra_nontarget", time == "[-1000 0]ms")
...
dat_plot <- DATA.In_longer %>%
  dplyr::select(subject, trialnumber, cue_validity_label, post_event_pos_label, post_hit, amplitude, signal, pos_rel_target, time)%>%
  filter(post_hit=="hit", signal == "SSVEP", pos_rel_target == "contra_target", time == "[-1000 0]ms")
...
*motor alpha models* pre target and post-target

* contra target motor alpha: **RT ~ motor_alpha + ( 1 | subjects)**
* contra target motor alpha + validity: **RT ~ Cue + motor_alpha + ( cue | subjects)**
...
*combined alpha and motor alpha models*
* pre vis alpha + pre mot alpha + cue **RT ~ visual_alpha_pre + mot_alpha_pre + cue + ( cue | subjects)**
* pre vis alpha + post mot alpha + cue **RT ~ visual_alpha_pre + mot_alpha_post + cue + ( cue | subjects)**
* pre mot alpha + post mot alpha + cue **RT ~ mot_alpha_pre + mot_alpha_post + cue + ( cue | subjects)**
* pre vis alphs + pre mot alpha + post mot alpha + cue **RT ~ visual_alpha_pre + mot_alpha_pre + mot_alpha_post + cue + ( cue | subjects)**
...
modeldata2 = DATA.In_longer %>%
  filter(post_hit == "hit", signal == "visualAlpha", time == "[-1000 0]ms", pos_rel_target == "contra_target")%>%
...
fit_validity_visalpha = brm(formula = post_RT ~ cue_validity_label + post_cue_vis_alpha_contra_target + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_visalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_visalpha = brm(formula = post_RT ~ cue_validity_label * post_cue_vis_alpha_contra_target + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_visalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
modeldata3 = DATA.In_longer %>%
  filter(post_hit == "hit", signal == "visualAlpha", time == "[-1000 0]ms", pos_rel_target == "contra_nontarget")%>%
...
fit_validity_alpha2 = brm(formula = post_RT ~ cue_validity_label + post_cue_vis_alpha_contra_nontarget + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_alpha2 = brm(formula = post_RT ~ cue_validity_label * post_cue_vis_alpha_contra_nontarget + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_alpha1_alpha2 = brm(formula = post_RT ~ contra_target + contra_nontarget + (1|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_targ_visalpha1_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_alpha1_alpha2 = brm(formula = post_RT ~ cue_validity_label + contra_target + contra_nontarget + (cue_validity_label|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_visalpha1_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_alpha1_alpha2 = brm(
  formula = post_RT ~ cue_validity_label * contra_target + cue_validity_label * contra_nontarget + (cue_validity_label|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_visalpha1_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_SSVEP = brm(formula = post_RT ~ cue_validity_label + post_cue_SSVEP_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_ssvep_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_SSVEP = brm(formula = post_RT ~ cue_validity_label * post_cue_SSVEP_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_ssvep_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# alter data to extract post-cue alpha contra to target
modeldata5 = DATA.In_longer %>%
  filter(post_hit == "hit", signal != "motorAlpha", time == "[-1000 0]ms")%>%
...
fit_SSVEP_alpha = brm(formula = post_RT ~ visualAlpha_contra_target + visualAlpha_contra_nontarget + SSVEP_contra_target + (1|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_targ_SSVEP_alpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_SSVEP_alpha = brm(formula = post_RT ~ cue_validity_label + visualAlpha_contra_target + visualAlpha_contra_nontarget + SSVEP_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_SSVEP_alpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_SSVEP_alpha = brm(
  formula = post_RT ~ cue_validity_label * visualAlpha_contra_target + cue_validity_label * visualAlpha_contra_nontarget + cue_validity_label * SSVEP_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_SSVEP_alpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_posttarg_motoralpha = brm(formula = post_RT ~ post_target_malpha_contra_target + (1|subject),
          data = modeldata6, 
          family = shifted_lognormal(),
          file = 'fit_posttarg_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_posttarg_validity_motoralpha = brm(formula = post_RT ~ cue_validity_label + post_target_malpha_contra_target + (cue_validity_label|subject),
          data = modeldata6, 
          family = shifted_lognormal(),
          file = 'fit_posttarg_validity_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_posttarg_validity_x_motoralpha = brm(formula = post_RT ~ cue_validity_label * post_target_malpha_contra_target + (cue_validity_label|subject),
          data = modeldata6, 
          family = shifted_lognormal(),
          file = 'fit_posttarg_validity_x_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motor alpha contra target
fit_motoralpha = brm(formula = post_RT ~ pre_target_malpha_contra_target + (1|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_targ_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motor alpha contra target + validity
fit_validity_motoralpha = brm(formula = post_RT ~ cue_validity_label + pre_target_malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_motoralpha = brm(formula = post_RT ~ cue_validity_label * pre_target_malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_targ_validity_x_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# combined models
modeldata8 = DATA.In_longer %>%
  filter(post_hit == "hit", signal != c("SSVEP"),  pos_rel_target == "contra_target")%>%
  dplyr::select(subject,trialnumber, cue_validity_label, signal, time, amplitude,post_RT)%>%
  pivot_wider(names_from = c("signal","time"), values_from = amplitude)%>%
  rename(motalpha_pre = `motorAlpha_[-1000 0]ms`,
         motalpha_post = `motorAlpha_[0 1000]ms`,
         visalpha_pre =`visualAlpha_[-1000 0]ms`,
         visalpha_post = `visualAlpha_[0 1000]ms`)
...
# visalpha motoralpha validity
fit_validity_visalpha_motalpha = brm(
  formula = post_RT ~ cue_validity_label + visalpha_pre + motalpha_pre + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visalpha post motoralpha validity
fit_validity_visalpha_post_motalpha = brm(
  formula = post_RT ~ cue_validity_label + visalpha_pre + motalpha_post + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha_post_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motalpha post motoralpha validity
fit_validity_motalpha_post_motalpha = brm(
  formula = post_RT ~ cue_validity_label + motalpha_pre + motalpha_post + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_motalpha_post_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visalpha motalpha post motoralpha validity
fit_validity_visalpha_motalpha_post_motalpha = brm(
  formula = post_RT ~ cue_validity_label + visalpha_pre + motalpha_pre + motalpha_post + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha_motalpha_post_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visalpha motoralpha validity
fit_validity_x_visalpha_motalpha = brm(
  formula = post_RT ~ cue_validity_label + visalpha_pre + motalpha_pre*cue_validity_label + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motalpha post motoralpha validity
fit_validity_x_motalpha_post_motalpha = brm(
  formula = post_RT ~ cue_validity_label * motalpha_pre + motalpha_post + cue_validity_label + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_motalpha_post_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visalpha motalpha post motoralpha validity
fit_validity_x_visalpha_motalpha_post_motalpha = brm(
  formula = post_RT ~ cue_validity_label + visalpha_pre + cue_validity_label * motalpha_pre + motalpha_post + (cue_validity_label|subject),
          data = modeldata8, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha_motalpha_post_motalpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# combined alpha model posttarget
# alter data to extract post-cue alpha contra to target
modeldata4 = DATA.In_longer %>%
  filter(post_hit == "hit", signal == "visualAlpha", time == "[0 1000]ms")%>%
  dplyr::select(subject, trialnumber, cue_validity_label, post_RT, pos_rel_target, amplitude) %>%
  pivot_wider(names_from = "pos_rel_target", values_from = amplitude)


# visual alpha contra target and contra non-target + validity
fit_posttarg_validity_x_alpha1_alpha2 = brm(
  formula = post_RT ~ cue_validity_label * contra_target + cue_validity_label * contra_nontarget + (cue_validity_label|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_posttarg_validity_x_visalpha1_visalpha2_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_motoralpha <- add_criterion(fit_motoralpha, c("loo", "waic", "bayes_R2"))
fit_validity_motoralpha <- add_criterion(fit_validity_motoralpha, c("loo", "waic", "bayes_R2"))
fit_validity_x_motoralpha <- add_criterion(fit_validity_x_motoralpha, c("loo", "waic", "bayes_R2"))


fit_posttarg_motoralpha <- add_criterion(fit_posttarg_motoralpha, c("loo", "waic", "bayes_R2"))
fit_posttarg_validity_motoralpha <- add_criterion(fit_posttarg_validity_motoralpha, c("loo", "waic", "bayes_R2"))
fit_posttarg_validity_x_motoralpha <- add_criterion(fit_posttarg_validity_x_motoralpha, c("loo", "waic", "bayes_R2"))

fit_validity_visalpha_motalpha <- add_criterion(fit_validity_visalpha_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_visalpha_post_motalpha <- add_criterion(fit_validity_visalpha_post_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_motalpha_post_motalpha <- add_criterion(fit_validity_motalpha_post_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_visalpha_motalpha_post_motalpha <- add_criterion(
  fit_validity_visalpha_motalpha_post_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_x_visalpha_motalpha <- add_criterion(fit_validity_x_visalpha_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_x_motalpha_post_motalpha <- add_criterion(fit_validity_x_motalpha_post_motalpha, c("loo", "waic", "bayes_R2"))
fit_validity_x_visalpha_motalpha_post_motalpha <- add_criterion(
  fit_validity_x_visalpha_motalpha_post_motalpha, c("loo", "waic", "bayes_R2"))

fit_posttarg_validity_x_alpha1_alpha2<- add_criterion(fit_posttarg_validity_x_alpha1_alpha2, c("loo", "waic", "bayes_R2"))
...
# pre-target alpha contra target
...
# pre-target alpha alpha contra nontarget
...
loo_compare(fit_intercept, fit_validity, fit_visalpha, fit_validity_visalpha, fit_validity_x_visalpha,
            fit_alpha2, fit_validity_alpha2, fit_validity_x_alpha2,
            fit_validity_alpha1_alpha2, fit_validity_x_alpha1_alpha2,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("all alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# pre-target alpha target ssvep
...
# pre-target motor alpha contra target
loo_compare(fit_intercept, fit_validity, fit_motoralpha, fit_validity_motoralpha, fit_validity_x_motoralpha, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("motor alpha contra target models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# pre-target alpha all models with validity as predictor
...
as.data.frame(rbind(
  ...
  bayes_R2(fit_visalpha), bayes_R2(fit_alpha2), bayes_R2(fit_motoralpha), bayes_R2(fit_SSVEP),
  ...
  bayes_R2(fit_validity_motoralpha), bayes_R2(fit_validity_x_motoralpha),
  ...
  row.names = c("fit_intercept","fit_validity",
                "fit_visalpha","fit_alpha2","fit_motoralpha","fit_SSVEP",
                "fit_validity_visalpha", "fit_validity_x_visalpha",
                "fit_validity_alpha2", "fit_validity_x_alpha2",
                "fit_validity_alpha1_alpha2", "fit_validity_x_alpha1_alpha2",
                "fit_validity_motalpha", "fit_validity_x_motalpha",
                "fit_validity_SSVEP","fit_validity_x_SSVEP",
                "fit_validity_SSVEP_alpha", "fit_validity_x_SSVEP_alpha"))%>%
...
data.frame(model_weight = model_weights(fit_intercept, fit_validity,
                            ...
                            fit_validity_SSVEP_alpha, fit_validity_x_SSVEP_alpha,
                            weights = "loo")) %>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("alpha, ssvep and combined models | model weights via model_weights(...)")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
# post-target motor alpha
loo_compare(fit_intercept, fit_validity, fit_posttarg_motoralpha, fit_posttarg_validity_motoralpha, fit_posttarg_validity_x_motoralpha,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("post target motor alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

as.data.frame(rbind(
  bayes_R2(fit_intercept), bayes_R2(fit_validity),
  bayes_R2(fit_posttarg_motoralpha), bayes_R2(fit_posttarg_validity_motoralpha),  bayes_R2(fit_posttarg_validity_x_motoralpha)),
  row.names = c("fit_intercept","fit_validity",
                "fit_posttarg_motoralpha", "fit_posttarg_validity_motoralpha","fit_posttarg_validity_x_motoralpha"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("post target motor alpha models | bayes_R2")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# additional all complex models
loo_compare(fit_intercept, fit_validity, 
            fit_posttarg_validity_motoralpha, fit_validity_motoralpha, fit_validity_visalpha,
            fit_validity_motalpha_post_motalpha, fit_validity_visalpha_post_motalpha, fit_validity_visalpha_motalpha,
            fit_validity_x_motalpha_post_motalpha, fit_validity_x_visalpha_motalpha,
            fit_validity_visalpha_motalpha_post_motalpha,  fit_validity_x_visalpha_motalpha_post_motalpha,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("post target motor alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
# print(g)
ggsave(filename = "figures/MarginEffects_VisAlphaTarg_PredSlopes_ModelValVisAlpha_PreTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_VisAlphaTarg_SlopeDistr_ModelValVisAlpha_PreTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
###  Extract marginal effects for pre-target visual interaction alpha model

Now for illustrating the whole picture, lets plot the visual alpha model

**'RT ~ Cue x vis_alpha_contratarg + ( cue | subjects)'**
...
###  Extract marginal effects from actual winning model 
...
###  Extract marginal effects for pre-target visual interaction alpha model contra target + nontarget
...
###  Extract marginal effects from pre-target SSVEP interaction model
...
###  Extract marginal effects for post-target motor alpha model

Now for illustrating the whole picture, lets plot the motor alpha model

**'RT ~ Cue + motor_alpha_Targ + ( cue | subjects)'**

```{r motor alpha model post-target marginal effects disp effects,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# based on https://www.andrewheiss.com/blog/2021/11/10/ame-bayes-re-guide/
# which model to use?
bestmodel.ef.model <- fit_posttarg_validity_motoralpha
# what is the data of the model?
bestmodel.ef.data <- bestmodel.ef.model$data
...
```{r motor alpha model post-target marginal effects disp effects VALIDITY -data,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# use range of data from orignal study 
bestmodel.ef.newdata3 <- expand_grid(
  cue_validity_label = c('valid','neutral','invalid'),
...
```{r motor alpha model post-target marginal effects disp effects VALIDITY -marginal means,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
...
```{r motor alpha model post-target marginal effects disp effects visual alpha -marginal means,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# now trying to get the regression line right for the alpha predictors
...
# print(g)
ggsave(filename = "figures/MarginEffects_MotAlphaTarg_PredSlopes_ModelValMotAlpha_PostTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_MotAlphaTarg_SlopeDistr_ModelValMotAlpha_PostTarget.eps", width = 5, height = 3.5,
       plot = print(g))
...
###  Extract marginal effects for post-target visual interaction alpha model contra target + nontarget

Now for illustrating the whole picture, lets plot the motor alpha model

**'RT ~ Cue x vis_alpha_contratarg + Cue x vis_alpha_contranontarg + ( cue | subjects)'**

```{r post targ visalphainter contra ipsi model pre marginal effects disp effects,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# based on https://www.andrewheiss.com/blog/2021/11/10/ame-bayes-re-guide/
# which model to use?
bestmodel.ef.model <- fit_posttarg_validity_x_alpha1_alpha2
# what is the data of the model?
bestmodel.ef.data <- bestmodel.ef.model$data
...
```{r post targ visalphainter model marginal effects disp effects VALIDITY -data ,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
# use range of data from orignal study 
bestmodel.ef.newdata3 <- expand_grid(
  cue_validity_label = c('valid','neutral','invalid'),
  contra_target = median(bestmodel.ef.data$contra_target),
...
```{r post targ visalphainter model marginal effects disp effects VALIDITY -marginal means,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
...
# print(g)
ggsave(filename = "figures/MarginEffects_PostTarget_FullModelVisAlpha_ValidityEffects.eps",
       width = 5, height = 3.5,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_PostTarget_FullModelVisAlpha_ValidityEffectContrasts.eps",
       width = 5, height = 3.5,
       plot = print(g))
```
...
```{r post targ visalphainter model marginal effects disp effects visual alpha inter -marginal means,  fig.height=4, fig.width=4,  warning = FALSE, message=FALSE, eval = TRUE}
# now trying to get the regression line right for the alpha predictors
...
# print(g)
ggsave(filename = "figures/MarginEffects_PostTarget_FullModelVisAlpha_AlphaContraTarget_Slopes.eps",
       width = 4, height = 4,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_PostTarget_FullModelVisAlpha_AlphaContraNonTarget_Slopes.eps",
       width = 4, height = 4,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_PostTarget_FullModelVisAlpha_Alpha_SlopeDistr.eps",
       width = 4, height = 4,
       plot = print(g))
