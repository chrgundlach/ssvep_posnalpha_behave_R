...
# cowplot::plot_grid(plot1, plot2, plot3, ncol = 3,labels = "AUTO")
plotttitle <- ggdraw() + draw_label("SSVEP amplitude", fontface='bold')
plotplots <- ggarrange(plot1, plot2, nrow = 2, align = "v", heights =c(4,2), common.legend = TRUE)
ggarrange(plotttitle, plotplots, nrow = 2, heights=c(0.1, 1))
```
<br>
...
## Fitting the models II
The models specified so far:
really only for signals contralateral to target
...
```{r model fits contra target, results = "hide",  fig.height=3.5, fig.width=5, warning = FALSE, message=FALSE}
# alter data to extract post-cue target SSVEPs
modeldata = DATA.In_longer %>%
...
fit_EEG_ct_SSVEP_intercept = brm(formula = target_SSVEP ~ 1 + (1|subject),
          data = modeldata, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_SSVEP_intercept_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_SSVEP_validity = brm(formula = target_SSVEP ~ attention + (attention|subject),
          data = modeldata, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_SSVEP_validity_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_vis_alpha_intercept = brm(formula = visalpha ~ 1 + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_vis_alpha_intercept_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_vis_alpha_validity = brm(formula = visalpha ~ 1 + attention + (attention|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_vis_alpha_targ_validity_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_mot_alpha_intercept = brm(formula = motalpha ~ 1 + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_mot_alpha_intercept_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_mot_alpha_validity = brm(formula = motalpha ~ 1 + attention + (attention|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_mot_alpha_validity_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_SSVEP_alpha = brm(formula = SSVEP ~ visualAlpha + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_SSVEP_alpha_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_SSVEP_validity_alpha = brm(formula = SSVEP ~ attention + visualAlpha + (attention|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_SSVEP_validity_alpha_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_SSVEP_validity_x_alpha = brm(formula = SSVEP ~ attention * visualAlpha + (attention|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEGv2_SSVEP_validity_x_alpha_ct_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_EEG_ct_SSVEP_intercept <- add_criterion(fit_EEG_ct_SSVEP_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_ct_SSVEP_validity <- add_criterion(fit_EEG_ct_SSVEP_validity, c("loo", "waic", "bayes_R2"))

fit_EEG_ct_vis_alpha_intercept <- add_criterion(fit_EEG_ct_vis_alpha_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_ct_vis_alpha_validity <- add_criterion(fit_EEG_ct_vis_alpha_validity, c("loo", "waic", "bayes_R2"))

fit_EEG_ct_mot_alpha_intercept <- add_criterion(fit_EEG_ct_mot_alpha_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_ct_mot_alpha_validity <- add_criterion(fit_EEG_ct_mot_alpha_validity, c("loo", "waic", "bayes_R2"))

fit_EEG_ct_SSVEP_alpha <- add_criterion(fit_EEG_ct_SSVEP_alpha, c("loo", "waic", "bayes_R2"))
fit_EEG_ct_SSVEP_validity_alpha <- add_criterion(fit_EEG_ct_SSVEP_validity_alpha, c("loo", "waic", "bayes_R2"))
fit_EEG_ct_SSVEP_validity_x_alpha <- add_criterion(fit_EEG_ct_SSVEP_validity_x_alpha, c("loo", "waic", "bayes_R2"))
...
# visual alpha model
loo_compare(fit_EEG_vis_alpha_intercept, fit_EEG_vis_alpha_validity, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("vis alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# motor alpha model
loo_compare(fit_EEG_mot_alpha_intercept, fit_EEG_mot_alpha_validity, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("mot alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# combined
loo_compare(fit_EEG_SSVEP_intercept, fit_EEG_SSVEP_validity,
            fit_EEG_SSVEP_alpha, fit_EEG_SSVEP_validity_alpha, fit_EEG_SSVEP_validity_x_alpha,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("SSVEP models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
as.data.frame(rbind(
  ...
  bayes_R2(fit_EEG_vis_alpha_intercept), bayes_R2(fit_EEG_vis_alpha_validity),
  bayes_R2(fit_EEG_mot_alpha_intercept), bayes_R2(fit_EEG_mot_alpha_validity),
  bayes_R2(fit_EEG_SSVEP_alpha), bayes_R2(fit_EEG_SSVEP_validity_alpha), bayes_R2(fit_EEG_SSVEP_validity_x_alpha)),
  row.names = c("fit_EEG_SSVEP_intercept","fit_EEG_SSVEP_validity",
                "fit_EEG_vis_alpha_intercept", "fit_EEG_vis_alpha_validity", 
                "fit_EEG_mot_alpha_intercept","fit_EEG_mot_alpha_validity", 
                "fit_EEG_SSVEP_alpha", "fit_EEG_SSVEP_validity_alpha","fit_EEG_SSVEP_validity_x_alpha"))%>%
...
# SSVEP models
loo_compare(fit_EEG_ct_SSVEP_intercept, fit_EEG_ct_SSVEP_validity, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("SSVEP models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# visual alpha model
loo_compare(fit_EEG_ct_vis_alpha_intercept, fit_EEG_ct_vis_alpha_validity, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("vis alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# motor alpha model
loo_compare(fit_EEG_ct_mot_alpha_intercept, fit_EEG_ct_mot_alpha_validity, criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("mot alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# combined
loo_compare(fit_EEG_ct_SSVEP_intercept, fit_EEG_ct_SSVEP_validity,
            fit_EEG_ct_SSVEP_alpha, fit_EEG_ct_SSVEP_validity_alpha, fit_EEG_ct_SSVEP_validity_x_alpha,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("SSVEP models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
as.data.frame(rbind(
  bayes_R2(fit_EEG_ct_SSVEP_intercept), bayes_R2(fit_EEG_ct_SSVEP_validity),
  bayes_R2(fit_EEG_ct_vis_alpha_intercept), bayes_R2(fit_EEG_ct_vis_alpha_validity),
  bayes_R2(fit_EEG_ct_mot_alpha_intercept), bayes_R2(fit_EEG_ct_mot_alpha_validity),
  bayes_R2(fit_EEG_ct_SSVEP_alpha), bayes_R2(fit_EEG_ct_SSVEP_validity_alpha), bayes_R2(fit_EEG_ct_SSVEP_validity_x_alpha)),
  row.names = c("fit_EEG_ct_SSVEP_intercept","fit_EEG_ct_SSVEP_validity",
                "fit_EEG_ct_vis_alpha_intercept", "fit_EEG_ct_vis_alpha_validity", 
                "fit_EEG_ct_mot_alpha_intercept","fit_EEG_ct_mot_alpha_validity", 
                "fit_EEG_ct_SSVEP_alpha", "fit_EEG_ct_SSVEP_validity_alpha","fit_EEG_ct_SSVEP_validity_x_alpha"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("alpha, ssvep and combined models | only contra target | bayes_R2")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
plot1 <-
  ggplot(bestmodel.ef.tidy_exppred, aes(
    x = .epred, 
    fill = attention, fill_ramp = after_stat(abs(x)), 
...
# print(g)
ggsave(filename = "figures/MarginEffects_SSVEPpredicted_by_validity_predictvals.eps", width = 5, height = 3.5,
       plot = print(g))
...
# print(g)
ggsave(filename = "figures/MarginEffects_SSVEPpredicted_by_validity_contrasts.eps", width = 5, height = 3.5,
       plot = print(g))
```
...
# cowplot::plot_grid(plot1, plot2, plot3, ncol = 3,labels = "AUTO")
plotttitle <- ggdraw() + draw_label("predicted visual alpha amplitude | for all model draws", fontface='bold')
plotplots <- ggarrange(plot1, plot2, nrow = 2, align = "v", heights =c(4,2), common.legend = TRUE)
ggarrange(plotttitle, plotplots, nrow = 2, heights=c(0.1, 1))
```
...
# cowplot::plot_grid(plot1, plot2, plot3, ncol = 3,labels = "AUTO")
plotttitle <- ggdraw() + draw_label("predicted motor alpha amplitude | for all model draws", fontface='bold')
plotplots <- ggarrange(plot1, plot2, nrow = 2, align = "v", heights =c(4,2), common.legend = TRUE)
ggarrange(plotttitle, plotplots, nrow = 2, heights=c(0.1, 1))
```
...
# based on https://www.andrewheiss.com/blog/2021/11/10/ame-bayes-re-guide/
# which model to use?
bestmodel.ef.model <- fit_EEG_SSVEP_validity_alpha
# what is the data of the model?
bestmodel.ef.data <- bestmodel.ef.model$data
...
theme_set(theme_bw())
ggplot(bestmodel.ef.ef_draws_validity, aes(y = attention, x = .value)) +
  stat_halfeye(
    aes(fill = attention, fill_ramp = after_stat(level)),
    .width = c(.95, 1),
    position = "dodgejust",
...
```{r SSVEP compl marginal effects disp effects visual alpha -marginal means,  fig.height=3.5, fig.width=5,  warning = FALSE, message=FALSE, eval = TRUE}
...
ggplot(bestmodel.ef.tidy_exppred2, aes(x = visualAlpha, y = .epred)) +
  ...
  labs(x = "alpha amplitude contra stimulus (cued, uncued, neutral)", y = "predicted SSVEP (cued, uncued, neutral)",
