---
title: "BRMS analysis | Posnalpha Behave | cue window | zscored by subject x cue_validity"
...
wd="C:/Users/EEG/Documents/R/Christopher/ssvep_posnalpha_behave_R" # work directory
...
fit_validity_x_alpha1_alpha2 = brm(
  formula = post_RT ~ cue_validity_label * contra_target + cue_validity_label * contra_nontarget + (cue_validity_label|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha1_visalpha2_zscorrev_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_SSVEP = brm(formula = post_RT ~ cue_validity_label * post_cue_SSVEP_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_ssvep_zscorrev_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
modeldata7 = DATA.In_longer %>%
  ...
  group_by(subject,cue_validity_label)%>%
  mutate("malpha_contra_target"=scale(malpha_contra_target)) %>%
  ungroup()
...
fit_validity_x_motoralpha = brm(formula = post_RT ~ cue_validity_label * malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_motoralpha_zscorrev_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# 
print(g)
# ggsave(filename = file.path("figures","MarginEffects_PostCue_FullModelVisAlpha_AlphaContraTarget_Slopes_zscored.eps"),
#        width = 4, height = 4,
#        plot = g)
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelVisAlpha_AlphaContraNonTarget_Slopes_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelVisAlpha_Alpha_SlopeDistr_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelSSVEP_SSVEP_Slopes_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelSSVEP_SSVEP_SlopeDistr_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelMotAlpha_MotAlpha_Slopes_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
...
print(g)
# ggsave(filename = "figures/MarginEffects_PostCue_FullModelMotAlpha_MotAlpha_SlopeDistr_zscored.eps",
#        width = 4, height = 4,
#        plot = print(g))
