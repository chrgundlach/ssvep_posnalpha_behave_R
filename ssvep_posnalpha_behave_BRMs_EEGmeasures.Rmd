---
title: "BRMS analysis | Posnalpha Behave | cue window | model EEG measures"
...
* intercept model: **target_SSVEP ~ 1 + ( 1 | subjects)**
* validity model: **target_SSVEP ~ Cue + ( cue | subjects)**

*visual alpha models*

* contra target, intercept model: **vis_alpha_target ~ 1 + ( 1 | subjects)**
* contra target, validity model: **vis_alpha_target ~ 1 + cue + ( cue | subjects)**
* contra nontarget, intercept model: **vis_alpha_nontarget ~ 1 + ( 1 | subjects)**
* contra nontarget, validity model: **vis_alpha_nontarget ~ 1 + cue + ( cue | subjects)**

*motor alpha models*

* contra target hand, intercept model: **mot_alpha_target ~ 1 + ( 1 | subjects)**
* contra target hand, validity model: **mot_alpha_target ~ 1 + cue + ( cue | subjects)**
* contra nontarget hand, intercept model: **mot_alpha_nontarget ~ 1 + ( 1 | subjects)**
* contra nontarget hand, validity model: **mot_alpha_nontarget ~ 1 + cue + ( cue | subjects)**

*ssvep predicted by alpha models*

* by target alpha: **target_SSVEP ~ vis_alpha_target + ( 1 | subjects)**
* by target alpha + validtiy: **target_SSVEP ~ vis_alpha_target + cue ( cue | subjects)**
* by nontarget alpha: **target_SSVEP ~ vis_alpha_nontarget + ( 1 | subjects)**
* by nontarget alpha + validtiy: **target_SSVEP ~ vis_alpha_nontarget + cue ( cue | subjects)**
* by nontarget + target alpha: **target_SSVEP ~ vis_alpha_nontarget + vis_alpha_target + ( 1 | subjects)**
* by nontarget + target alpha + validtiy: **target_SSVEP ~ vis_alpha_nontarget + vis_alpha_target + cue ( cue | subjects)** 
...
fit_EEG_SSVEP_intercept = brm(formula = target_SSVEP ~ 1 + (1|subject),
          ...
          file = 'fit_EEG_SSVEP_intercept_slog',
...
fit_EEG_SSVEP_validity = brm(formula = target_SSVEP ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldata, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_vis_alpha_targ_intercept = brm(formula = contra_target ~ 1 + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_vis_alpha_targ_intercept_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_vis_alpha_targ_validity = brm(formula = contra_target ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_vis_alpha_targ_validity_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_vis_alpha_nontarg_intercept = brm(formula = contra_nontarget ~ 1 + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_vis_alpha_nontarg_intercept_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_vis_alpha_nontarg_validity = brm(formula = contra_nontarget ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_vis_alpha_nontarg_validity_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_mot_alpha_targ_intercept = brm(formula = contra_target ~ 1 + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_mot_alpha_targ_intercept_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_mot_alpha_targ_validity = brm(formula = contra_target ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_mot_alpha_targ_validity_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_mot_alpha_nontarg_intercept = brm(formula = contra_nontarget ~ 1 + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_mot_alpha_nontarg_intercept_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_mot_alpha_nontarg_validity = brm(formula = contra_nontarget ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_EEG_mot_alpha_nontarg_validity_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
modeldata3 = DATA.In_longer %>%
  filter(post_hit == "hit", signal != "motorAlpha", time == "[500 1500]ms")%>%
  dplyr::select(-side, -Zamplitude, -attention)%>%
  pivot_wider(names_from = c(pos_rel_target, signal), values_from = amplitude)%>%
  dplyr::rename(target_SSVEP = contra_target_SSVEP)
...
fit_EEG_SSVEP_alpha_target = brm(formula = target_SSVEP ~ contra_target_visualAlpha + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_alpha_target_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_validity_alpha_target = brm(formula = target_SSVEP ~ cue_validity_label + contra_target_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_alpha_target_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_alpha_nontarget = brm(formula = target_SSVEP ~ contra_nontarget_visualAlpha + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_alpha_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_validity_alpha_nontarget = brm(formula = target_SSVEP ~ cue_validity_label + contra_nontarget_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_alpha_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_alpha_target_nontarget = brm(formula = target_SSVEP ~ contra_target_visualAlpha + contra_nontarget_visualAlpha + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_alpha_target_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_validity_alpha_target_nontarget = brm(formula = target_SSVEP ~ cue_validity_label + contra_target_visualAlpha + contra_nontarget_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_alpha_target_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
# interaction models
fit_EEG_SSVEP_validity_x_alpha_target = brm(formula = target_SSVEP ~ cue_validity_label * contra_target_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_x_alpha_target_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_validity_x_alpha_nontarget = brm(formula = target_SSVEP ~ cue_validity_label * contra_nontarget_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_x_alpha_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_SSVEP_validity_x_alpha_target_nontarget = brm(formula = target_SSVEP ~ cue_validity_label * contra_target_visualAlpha + cue_validity_label * contra_nontarget_visualAlpha + (cue_validity_label|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_x_alpha_target_nontarget_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
fit_EEG_vis_alpha_targ_intercept <- add_criterion(fit_EEG_vis_alpha_targ_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_vis_alpha_targ_validity <- add_criterion(fit_EEG_vis_alpha_targ_validity, c("loo", "waic", "bayes_R2"))
fit_EEG_vis_alpha_nontarg_intercept <- add_criterion(fit_EEG_vis_alpha_nontarg_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_vis_alpha_nontarg_validity <- add_criterion(fit_EEG_vis_alpha_nontarg_validity, c("loo", "waic", "bayes_R2"))
fit_EEG_mot_alpha_targ_intercept <- add_criterion(fit_EEG_mot_alpha_targ_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_mot_alpha_targ_validity <- add_criterion(fit_EEG_mot_alpha_targ_validity, c("loo", "waic", "bayes_R2"))
fit_EEG_mot_alpha_nontarg_intercept <- add_criterion(fit_EEG_mot_alpha_nontarg_intercept, c("loo", "waic", "bayes_R2"))
fit_EEG_mot_alpha_nontarg_validity <- add_criterion(fit_EEG_mot_alpha_nontarg_validity, c("loo", "waic", "bayes_R2"))

fit_EEG_SSVEP_alpha_target <- add_criterion(fit_EEG_SSVEP_alpha_target, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_alpha_nontarget <- add_criterion(fit_EEG_SSVEP_alpha_nontarget, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_alpha_target_nontarget <- add_criterion(fit_EEG_SSVEP_alpha_target_nontarget, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_validity_alpha_target <- add_criterion(fit_EEG_SSVEP_validity_alpha_target, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_validity_alpha_nontarget <- add_criterion(fit_EEG_SSVEP_validity_alpha_nontarget, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_validity_alpha_target_nontarget <- add_criterion(fit_EEG_SSVEP_validity_alpha_target_nontarget, c("loo", "waic", "bayes_R2"))

fit_EEG_SSVEP_validity_x_alpha_target <- add_criterion(fit_EEG_SSVEP_validity_x_alpha_target, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_validity_x_alpha_nontarget <- add_criterion(fit_EEG_SSVEP_validity_x_alpha_nontarget, c("loo", "waic", "bayes_R2"))
fit_EEG_SSVEP_validity_x_alpha_target_nontarget <- add_criterion(fit_EEG_SSVEP_validity_x_alpha_target_nontarget, c("loo", "waic", "bayes_R2"))
...
# vis alpha models
loo_compare(fit_EEG_vis_alpha_targ_intercept, fit_EEG_vis_alpha_targ_validity, fit_EEG_vis_alpha_nontarg_intercept, fit_EEG_vis_alpha_nontarg_validity,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("vis alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# motor alpha models
loo_compare(fit_EEG_mot_alpha_targ_intercept, fit_EEG_mot_alpha_targ_validity, fit_EEG_mot_alpha_nontarg_intercept, fit_EEG_mot_alpha_nontarg_validity,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(6,6,6,6,6,6,6,6,6), caption = c("motor alpha models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
