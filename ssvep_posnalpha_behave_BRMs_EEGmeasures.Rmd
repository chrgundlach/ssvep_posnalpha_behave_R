...
fit_EEG_SSVEP_validity = brm(formula = target_SSVEP ~ 1 + cue + (cue|subject),
          data = modeldata, 
          family = shifted_lognormal(),
...
fit_EEG_vis_alpha_targ_validity = brm(formula = contra_target ~ 1 + cue + (cue|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
...
fit_EEG_vis_alpha_nontarg_validity = brm(formula = contra_nontarget ~ 1 + cue + (cue|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
...
fit_EEG_mot_alpha_targ_validity = brm(formula = contra_target ~ 1 + cue + (cue|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
...
fit_EEG_mot_alpha_nontarg_validity = brm(formula = contra_nontarget ~ 1 + cue + (cue|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
...
fit_EEG_SSVEP_validity_alpha_target = brm(formula = target_SSVEP ~ cue + contra_target_visualAlpha + (cue|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
...
fit_EEG_SSVEP_validity_alpha_nontarget = brm(formula = target_SSVEP ~ cue + contra_nontarget_visualAlpha + (cue|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_EEG_SSVEP_validity_alpha_target_slog',
          save_pars = save_pars(all = TRUE),
...
fit_EEG_SSVEP_validity_alpha_target_nontarget = brm(formula = target_SSVEP ~ cue + contra_target_visualAlpha + contra_nontarget_visualAlpha + (cue|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
