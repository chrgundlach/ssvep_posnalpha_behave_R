...
med_model2 = brm(formula = contra_target ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldatat2, 
          family = shifted_lognormal(),
...
bayestestR::mediation(m2, treatment = "cue_validity_label", mediator = "contra_target")
