...
med_model1b = brm(formula = contra_target ~ 1 + cue_validity_label + (cue_validity_label|subject),
          data = modeldatat2, 
          family = shifted_lognormal(),
          file = 'med_model1b_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4
          # file_refit = "always"
...
m2 <- brm(f1 + f2 + set_rescor(FALSE), 
          data = modeldatat2,
          family = shifted_lognormal(),
          file = 'med_model2_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4)


m2b <- brm(f2 + f1 + set_rescor(FALSE), 
          data = modeldatat2,
          family = shifted_lognormal(),
          file = 'med_model2b_slog',
          save_pars = save_pars(all = TRUE),
          file_refit = "on_change",
          cores = 4)
...
# m3 <- stan_mvmer(
#   list(
#     contra_target ~ cue_validity_label + (cue_validity_label|subject),
#     post_RT ~ cue_validity_label + contra_target + (cue_validity_label|subject)
#   ),
#   data = modeldatat2b,
#   cores = 4
# )
...
# m4 <- stan_mvmer(
#   list(
#     contra_target ~ cue_validity_label + (1|subject),
#     post_RT ~ cue_validity_label + contra_target + (1|subject)
#   ),
#   data = modeldatat2b,
#   cores = 4
# )
...
# 
# bayestestR::mediation(m3, )
# mediation(m3, centrality = "mean", ci = .95)
# 
# bayestestR::mediation(m4, )
# mediation(m3, centrality = "mean", ci = .95)
