...
### Fitting and comparing the models pt 2 
...
loo_compare(fit_intercept_withndt_priors,  fit_validity_withndt_priors2, fit_validity_visalphaContra_withndt_priors2, 
            criterion = c("loo"))%>%
...
```{r model fits 2, results = "hide",  fig.height=3.5, fig.width=5, warning = FALSE, message=FALSE}
modeldata = DATA.In_long %>%
  filter(post_hit == "hit")
