...
# intercept model
fit_intercept_CueNested = brm(formula = post_RT ~ 1 + (cue_validity_label|subject),
          data = modeldata, 
          family = shifted_lognormal(),
          file = 'fit_intercept_CueNested_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_intercept_CueNested <- add_criterion(fit_intercept_CueNested, c("loo", "waic", "bayes_R2"))
...
as.data.frame(rbind(
  bayes_R2(fit_intercept), bayes_R2(fit_intercept_CueNested), bayes_R2(fit_validity_of), bayes_R2(fit_validity),
  ...
  row.names = c("fit_intercept","fit_intercept_CueNested", "fit_validity_onlyfixed", "fit_validity",
