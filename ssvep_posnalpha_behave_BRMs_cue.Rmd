...
# only fixed
fit_validity_of = brm(formula = post_RT ~ cue_validity_label + (1|subject),
          data = modeldata, 
          family = shifted_lognormal(),
          file = 'fit_validity_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_visalpha_of = brm(formula = post_RT ~ cue_validity_label + post_cue_vis_alpha_contra_target + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra target * validity only fixed
fit_validity_x_visalpha_of = brm(formula = post_RT ~ cue_validity_label * post_cue_vis_alpha_contra_target + (1|subject),
          data = modeldata2, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra nontarget + validity only fixed
fit_validity_alpha2_of = brm(formula = post_RT ~ cue_validity_label + post_cue_vis_alpha_contra_nontarget + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha2_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra nontarget + validity only fixed
fit_validity_x_alpha2_of = brm(formula = post_RT ~ cue_validity_label * post_cue_vis_alpha_contra_nontarget + (1|subject),
          data = modeldata3, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha2_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra target and contra non-target + validity only fixed
fit_validity_alpha1_alpha2_of = brm(formula = post_RT ~ cue_validity_label + contra_target + contra_nontarget + (1|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_validity_visalpha1_visalpha2_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra target and contra non-target + validity only fixed
fit_validity_x_alpha1_alpha2_of = brm(
  formula = post_RT ~ cue_validity_label * contra_target + cue_validity_label * contra_nontarget + (1|subject),
          data = modeldata4, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_visalpha1_visalpha2_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# SSVEP + validity model only fixed
fit_validity_SSVEP_of = brm(formula = post_RT ~ cue_validity_label + post_cue_SSVEP_contra_target + (1|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_validity_ssvep_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_SSVEP_of = brm(formula = post_RT ~ cue_validity_label * post_cue_SSVEP_contra_target + (1|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_ssvep_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# visual alpha contra target and contra non-target and SSVEP  + validity only fixed
fit_validity_SSVEP_alpha_of = brm(formula = post_RT ~ cue_validity_label + visualAlpha_contra_target + visualAlpha_contra_nontarget + SSVEP_contra_target + (1|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_validity_SSVEP_alpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_x_SSVEP_alpha_of = brm(
  formula = post_RT ~ cue_validity_label * visualAlpha_contra_target + cue_validity_label * visualAlpha_contra_nontarget + cue_validity_label * SSVEP_contra_target + (1|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_SSVEP_alpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
modeldata7 = DATA.In_longer %>%
  filter(post_hit == "hit", signal == "motorAlpha", time == "[500 1500]ms", pos_rel_target == "contra_target")%>%
  mutate(malpha_contra_target = amplitude)

# motor alpha contra target
fit_motoralpha = brm(formula = post_RT ~ malpha_contra_target + (1|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
fit_validity_motoralpha = brm(formula = post_RT ~ cue_validity_label + malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_validity_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motor alpha contra target * validity
fit_validity_x_motoralpha = brm(formula = post_RT ~ cue_validity_label * malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_motoralpha_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motor alpha contra target + validity only fixed
fit_validity_motoralpha_of = brm(formula = post_RT ~ cue_validity_label + malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_validity_motoralpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
# motor alpha contra target * validity only fixed
fit_validity_x_motoralpha_of = brm(formula = post_RT ~ cue_validity_label * malpha_contra_target + (cue_validity_label|subject),
          data = modeldata7, 
          family = shifted_lognormal(),
          file = 'fit_validity_x_motoralpha_of_slog',
          save_pars = save_pars(all = TRUE),
          # file_refit = "on_change",
          # file_refit = "always",
          file_refit = "never",
...
```{r model fits 2, results = "hide",  fig.height=3.5, fig.width=5, warning = FALSE, message=FALSE, eval=FALSE}
modeldata = DATA.In_long %>%
  filter(post_hit == "hit")
...
# intercept model
fit_intercept_withndt = brm(
  formula = bf(
    post_RT ~ 1 + (1|subject),
    ndt ~ 1 + (1|subject)),
  data = modeldata, 
  family = shifted_lognormal(),
  file = 'fit_intercept_withndt_slog',
  save_pars = save_pars(all = TRUE),
  # file_refit = "on_change",
  # file_refit = "always",
  file_refit = "never",
...
# validity model
fit_validity_withndt = brm(
  formula = bf(
    post_RT ~ cue_validity_label + (cue_validity_label|subject),
    ndt ~ subject),
  data = modeldata, 
  family = shifted_lognormal(),
  file = 'fit_validity_withndt_slog',
  save_pars = save_pars(all = TRUE),
  # file_refit = "on_change",
  # file_refit = "always",
  file_refit = "never",
...
# visual alpha contra target
fit_visalpha_withndt = brm(
  formula = bf(
    post_RT ~ post_cue_vis_alpha_contra_target + (1|subject),
    ndt ~ subject),
  data = modeldata2, 
  family = shifted_lognormal(),
  file = 'fit_visalpha_withndt_slog',
  save_pars = save_pars(all = TRUE),
  # file_refit = "on_change",
  # file_refit = "always",
  file_refit = "never",
...
# visual alpha contra target + validity
fit_validity_visalpha_withndt = brm(
  formula = bf(
    post_RT ~ cue_validity_label + post_cue_vis_alpha_contra_target + (cue_validity_label|subject),
    ndt ~ subject),
  data = modeldata2, 
  family = shifted_lognormal(),
  file = 'fit_validity_withndt_visalpha_slog',
  save_pars = save_pars(all = TRUE),
  # file_refit = "on_change",
  # file_refit = "always",
  file_refit = "never",
...
# visual alpha contra target * validity
fit_validity_x_visalpha_withndt = brm(
  formula = bf(
    post_RT ~ cue_validity_label * post_cue_vis_alpha_contra_target + (cue_validity_label|subject),
    ndt ~ subject),
  data = modeldata2, 
  family = shifted_lognormal(),
  file = 'fit_validity_x_visalpha_withndt_slog',
  save_pars = save_pars(all = TRUE),
  # file_refit = "on_change",
  # file_refit = "always",
  file_refit = "never",
...
summary(fit_intercept_withndt)
summary(fit_intercept)
summary(fit_validity_withndt)
summary(fit_visalpha_withndt)
summary(fit_validity_visalpha_withndt)
summary(fit_validity_x_visalpha_withndt)

# adding information criteria
fit_intercept_withndt <- add_criterion(fit_intercept_withndt, c("loo", "waic", "bayes_R2"))
fit_validity_withndt <- add_criterion(fit_validity_withndt, c("loo", "waic", "bayes_R2"))

fit_visalpha_withndt <- add_criterion(fit_visalpha_withndt, c("loo", "waic", "bayes_R2"))
fit_validity_visalpha_withndt <- add_criterion(fit_validity_visalpha_withndt, c("loo", "waic", "bayes_R2"))
fit_validity_x_visalpha_withndt <- add_criterion(fit_validity_x_visalpha_withndt, c("loo", "waic", "bayes_R2"))
...
# only fixed effects
fit_validity_of <- add_criterion(fit_validity_of, c("loo", "waic", "bayes_R2"))

fit_validity_visalpha_of <- add_criterion(fit_validity_visalpha_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_visalpha_of <- add_criterion(fit_validity_x_visalpha_of, c("loo", "waic", "bayes_R2"))
fit_validity_alpha2_of <- add_criterion(fit_validity_alpha2_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_alpha2_of <- add_criterion(fit_validity_x_alpha2_of, c("loo", "waic", "bayes_R2"))
fit_validity_alpha1_alpha2_of <- add_criterion(fit_validity_alpha1_alpha2_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_alpha1_alpha2_of <- add_criterion(fit_validity_x_alpha1_alpha2_of, c("loo", "waic", "bayes_R2"))

fit_validity_SSVEP_of <- add_criterion(fit_validity_SSVEP_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_SSVEP_of <- add_criterion(fit_validity_x_SSVEP_of, c("loo", "waic", "bayes_R2"))
fit_validity_SSVEP_alpha_of <- add_criterion(fit_validity_SSVEP_alpha_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_SSVEP_alpha_of <- add_criterion(fit_validity_x_SSVEP_alpha_of, c("loo", "waic", "bayes_R2"))

fit_validity_motoralpha_of <- add_criterion(fit_validity_motoralpha_of, c("loo", "waic", "bayes_R2"))
fit_validity_x_motoralpha_of <- add_criterion(fit_validity_x_motoralpha_of, c("loo", "waic", "bayes_R2"))
...
# summary(fit_validity_x_visalpha)
# summary(fit_alpha2)
# summary(fit_validity_alpha2)
# summary(fit_validity_x_alpha2)
# summary(fit_alpha1_alpha2)
# summary(fit_validity_alpha1_alpha2)
# summary(fit_validity_x_alpha1_alpha2)
# summary(fit_SSVEP)
# summary(fit_validity_SSVEP)
# summary(fit_validity_x_SSVEP)
# summary(fit_SSVEP_alpha)
# summary(fit_validity_SSVEP_alpha)
# summary(fit_validity_x_SSVEP_alpha)
# summary(fit_motoralpha)
# summary(fit_validity_motoralpha)
# summary(fit_validity_x_motoralpha)
...
loo_compare(fit_intercept, fit_validity, fit_visalpha, fit_validity_visalpha, fit_validity_x_visalpha, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha contra target models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# alpha contra target only fixed
loo_compare(fit_intercept,  fit_validity_of, fit_visalpha, fit_validity_visalpha_of, fit_validity_x_visalpha_of, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha contra target models only fixed | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# alpha contra nontarget
loo_compare(fit_intercept, fit_validity, fit_alpha2, fit_validity_alpha2, fit_validity_x_alpha2, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha contra nontarget models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# alpha contra nontarget only fixed
loo_compare(fit_intercept, fit_validity_of, fit_alpha2, fit_validity_alpha2_of, fit_validity_x_alpha2_of, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha contra nontarget models only fixed | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
# all visual alpha | only fixed
loo_compare(fit_intercept, fit_validity_of, fit_visalpha, fit_validity_visalpha_of, fit_validity_x_visalpha_of,
            fit_alpha2, fit_validity_alpha2_of, fit_validity_x_alpha2_of,
            fit_validity_alpha1_alpha2_of, fit_validity_x_alpha1_alpha2_of,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha contra target models only fixed | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# target ssvep
loo_compare(fit_intercept, fit_validity, fit_SSVEP, fit_validity_SSVEP, fit_validity_x_SSVEP,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("target SSVEP models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# target ssvep only fixed
loo_compare(fit_intercept, fit_validity_of, fit_SSVEP, fit_validity_SSVEP_of, fit_validity_x_SSVEP_of, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("target SSVEP models only fixed | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# motor alpha contra target
loo_compare(fit_intercept, fit_validity, fit_motoralpha, fit_validity_motoralpha, fit_validity_x_motoralpha, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("motor alpha contra target models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

# motor alpha contra target only fixed
loo_compare(fit_intercept, fit_validity_of,  fit_motoralpha, fit_validity_motoralpha_of, fit_validity_x_motoralpha_of,
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("motor alpha contra target models only fixed | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))
...
loo_compare(fit_intercept, fit_validity,
            ...
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), caption = c("alpha, ssvep and combined models | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

loo_compare(fit_intercept, fit_validity_of,
            fit_validity_visalpha_of, fit_validity_x_visalpha_of,
            fit_validity_alpha2_of, fit_validity_x_alpha2_of,
            fit_validity_alpha1_alpha2_of, fit_validity_x_alpha1_alpha2_of, 
            fit_validity_SSVEP_of, fit_validity_x_SSVEP_of, 
            fit_validity_SSVEP_alpha_of, fit_validity_x_SSVEP_alpha_of, 
            criterion = c("loo"))%>%
  kable(escape = F, digits = c(9,9,9,9,9,9,9,9,9), 
        caption = c("alpha, ssvep and combined models | only fixed effects | loo comparison")) %>%
  kable_styling("striped", full_width = T, bootstrap_options = c("striped", "hover", "condensed", "responsive",font_size = 8))

as.data.frame(rbind(
  bayes_R2(fit_intercept), bayes_R2(fit_validity_of), bayes_R2(fit_validity),
  bayes_R2(fit_visalpha), bayes_R2(fit_alpha2), bayes_R2(fit_motoralpha), bayes_R2(fit_SSVEP),
  bayes_R2(fit_validity_visalpha_of), bayes_R2(fit_validity_x_visalpha_of),
  bayes_R2(fit_validity_visalpha), bayes_R2(fit_validity_x_visalpha),
  bayes_R2(fit_validity_alpha2_of), bayes_R2(fit_validity_x_alpha2_of),
  bayes_R2(fit_validity_alpha2), bayes_R2(fit_validity_x_alpha2),
  bayes_R2(fit_validity_alpha1_alpha2_of), bayes_R2(fit_validity_x_alpha1_alpha2_of),
  ...
  bayes_R2(fit_validity_SSVEP_of), bayes_R2(fit_validity_x_SSVEP_of),
  bayes_R2(fit_validity_SSVEP), bayes_R2(fit_validity_x_SSVEP),
  bayes_R2(fit_validity_SSVEP_alpha_of), bayes_R2(fit_validity_x_SSVEP_alpha_of),
  bayes_R2(fit_validity_SSVEP_alpha), bayes_R2(fit_validity_x_SSVEP_alpha)),
  row.names = c("fit_intercept","fit_validity_onlyfixed", "fit_validity",
