...
# visual alpha contra target and contra non-target and SSVEP  + validity
fit_validity_SSVEP_alpha = brm(formula = post_RT ~ cue_validity_label + visualAlpha_contra_target + visualAlpha_contra_nontarget + SSVEP_z_contra_target + (cue_validity_label|subject),
          data = modeldata5, 
          family = shifted_lognormal(),
