...
plot(conditional_effects(testfit_intecept_noPRIORs), ask = FALSE)
plot(testfit_intecept_withPRIORs, ask = FALSE)
plot(conditional_effects(testfit_intecept_withPRIORs), ask = FALSE)
plot(testfit_intecept_ndt_noPRIORs, ask = FALSE)
plot(conditional_effects(testfit_intecept_ndt_noPRIORs), ask = FALSE)
plot(testfit_intecept_ndt_withPRIORs, ask = FALSE)
plot(conditional_effects(testfit_intecept_ndt_withPRIORs), ask = FALSE)
